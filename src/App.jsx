    ...
    <div className="app-shell">
      <header className="site-header">
        ...
        <nav className="main-nav" aria-label="Primary navigation">
          <a href="/#search" onClick={(event) => handleNavView(event, 'search', 'search')}>
            Search
          </a>
          <a href="/#how-it-works" onClick={(event) => handleNavView(event, 'search', 'how-it-works')}>
            How it works
          </a>
          <button
            className={`status-link ${activeView === 'status' ? 'active' : ''}`}
            type="button"
            onClick={(event) => handleNavView(event, 'status')}
          >
            Status
          </button>
        </nav>
      ...
      <footer className="site-footer">
        ...
        <div className="footer-links">
          <a href="/privacy" onClick={goToPrivacyPage}>Privacy Policy</a>
          <button
